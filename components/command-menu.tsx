...
export const CommandMenu = () => {
  ...
  useEffect(() => {
    const toggleCommandMenu = (e: MouseEvent) => {
      ...
      const isMenuButton =
        e.target instanceof Element && e.target.classList.contains("command-menu-button");
  ...
  const currentOptions = useMemo(() => {
    const options =
      selectedOption === null ? commandOptions : commandOptions[selectedOption].subOptions;
